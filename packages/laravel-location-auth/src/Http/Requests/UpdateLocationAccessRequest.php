...
namespace Sitebound\LocationAuth\Http\Requests;
...
class UpdateLocationAccessRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        $ability = config('location-auth.routes.settings_gate');

        if (! is_string($ability) || $ability === '') {
            return true;
        }

        return Gate::forUser($this->user())->allows($ability);
    }
