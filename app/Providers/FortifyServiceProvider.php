...
use App\Actions\Fortify\EnsureLoginIsWithinAllowedLocation;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    private function configureViews(): void
    {
        Fortify::loginView(fn (Request $request) => Inertia::render('auth/Login', [
            ...
            'locationAccess' => $this->locationAccessLoginConfiguration(),
    ...
    /**
     * Configure the Fortify authentication pipeline.
     */
    private function configureAuthenticationPipeline(): void
    {
        Fortify::authenticateThrough(fn (Request $request) => array_filter([
            ...
            EnsureLoginIsWithinAllowedLocation::class,
    ...
    /**
     * Get the login geofence configuration for the frontend.
     *
     * @return array<string, bool|float|int|null>
     */
    private function locationAccessLoginConfiguration(): array
    {
